...
class SpareModelServices():
    ...
    def get_spare_model_by_spare_service_id(self,spare_service_id):
        result =self.db.query(SpareModel) .filter (SpareModel.spare_service_id ==spare_service_id).all()
        return result
    ...
    def update_spare_model (self, id:int, data :SpareModel):
        ...
        update_spare.spare_service_id = data.is_active
        self.db.commit()
        return
